...
const Pages = [
  {
    ...
    title: 'Services',
    children: [
      { id: 211, title: 'Front end development', url: '/services-1' },
      { id: 212, title: 'Full Stack development', url: '/services-2' },
      { id: 211, title: 'Mobile App development', url: '/services-1' },
      { id: 212, title: 'UI UX Design', url: '/services-2' }
    ]
  },
  {
    id: 22,
...
export { Pages,About, Services,Blogs,Contact };
